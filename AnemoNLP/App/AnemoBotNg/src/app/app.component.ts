...
export class AppComponent implements OnInit {
  ...
  chatbot_start() {
    ...
    $('<div class="message loading new"><figure class="avatar"><img src=../img/' + this.bot.img[this.bot.change % 2] + ' /></figure><span></span></div>').appendTo($('.messages-content'));
    this.bot.updateScrollbar();

    var getter = this.http.get(this.bot.urlSearch)
    getter.subscribe(_data => {
